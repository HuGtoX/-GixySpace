		...
		<>
			...
			<div className="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-md">
				<div className="flex justify-between items-center mb-3">
					...
					<button className="text-primary dark:text-dark-primary hover:text-primary/80 dark:hover:text-dark-primary/80">
				...
				<div className="space-y-3">
					<div className="flex items-center">
						...
						/>
						<label className="ml-2 text-sm line-through text-gray-400">
							完成项目报告
						</label>
					</div>
					<div className="flex items-center">
						<input
							...
							className="w-4 h-4 text-primary dark:text-dark-primary rounded"
						/>
						<label className="ml-2 text-sm">回复客户邮件</label>
					</div>
					<div className="flex items-center">
						<input
							type="checkbox"
							...
							className="w-4 h-4 text-primary dark:text-dark-primary rounded"
						/>
						<label className="ml-2 text-sm">准备演示文稿</label>
					</div>
					<div className="flex items-center">
						<input
							type="checkbox"
							...
							className="w-4 h-4 text-primary dark:text-dark-primary rounded"
						/>
						<label className="ml-2 text-sm">与团队开会</label>
					</div>
				</div>
			</div>
